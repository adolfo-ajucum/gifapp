// To parse this data:
//
//   import { Convert, SeachGifsResponde } from "./file";
//
//   const seachGifsResponde = Convert.toSeachGifsResponde(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SeachGifsResponde {
    data:       Gif[];
...
export class Convert {
    public static toSeachGifsResponde(json: string): SeachGifsResponde {
        return cast(JSON.parse(json), r("SeachGifsResponde"));
    }

    public static seachGifsRespondeToJson(value: SeachGifsResponde): string {
        return JSON.stringify(uncast(value, r("SeachGifsResponde")), null, 2);
    }
}
